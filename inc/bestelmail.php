...
<div class="container">
    <br>
    <h3> Beste <?php echo $_SESSION['voornaam'];
        echo ' ' . $_SESSION['achternaam']; ?>, Bedankt voor uw bestelling</h3>
    <br>
    ...
    <br>
    <br>
    <h6> Het totaalbedrag inclusief verzendkosten:
        €<?php echo prijsVanBestelling($winkelmandid, $kortingscode, $conn); ?></h6>
    <br>
